...
p1 <- ggbetweenstats(data = RTdata1, x = Identity, y = RT,  
                     xlab = "Good", ylab = "Reaction times (ms)",
...
p2 <- ggbetweenstats(data = RTdata2, x = Identity, y = RT,  
                     xlab = "Bad", ylab = "",
                     type = FALSE) + theme_classic() + theme(legend.position = "none",
                                                             text=element_text(family='Times'),
                                                             axis.line.x=element_line(size=1.2),
...
p1 <- ggbetweenstats(data = Ddata1, x = Identity, y = dprime,  
                     xlab = "Good", ylab = "d prime",
                     type = FALSE) + theme_classic() + theme(legend.position = "none",
                                                             text=element_text(family='Times'),
                                                             axis.line.x=element_line(size=1.2),
                                                             axis.line.y=element_line(size=1.2),
...
p2 <- ggbetweenstats(data = Ddata2, x = Identity, y = dprime,  
                     xlab = "Bad", ylab = "",
                     type = FALSE) + theme_classic() + theme(legend.position = "none",
                                                             text=element_text(family='Times'),
                                                             axis.line.x=element_line(size=1.2),
...
p1 <- ggbetweenstats(data = ACCdata1, x = Identity, y = ACC,  
                     xlab = "Good", ylab = "Accuracy",
                     type = FALSE) + theme_classic() + theme(legend.position = "none",
                                                             text=element_text(family='Times'),
                                                             axis.line.x=element_line(size=1.2),
                                                             axis.line.y=element_line(size=1.2),
...
p2 <- ggbetweenstats(data = ACCdata2, x = Identity, y = ACC,  
                     xlab = "Bad", ylab = "",
                     type = FALSE) + theme_classic() + theme(legend.position = "none",
                                                             text=element_text(family='Times'),
                                                             axis.line.x=element_line(size=1.2),
...
p1 <- ggbetweenstats(data = RTdata1, x = Identity, y = RT,  
                     xlab = "Good", ylab = "Reaction times (ms)",
                     type = FALSE) + scale_y_continuous(limits = c(300,900),breaks = seq(300,900,100)) +
                     theme_classic() + theme(legend.position = "none",
                                                             ...
                                                             axis.text.y=element_text(size=14, color = "black"),
                                                             axis.ticks.x=element_line(size=1.2),
                                                             axis.ticks.y=element_line(size=1.2)) +scale_y_continuous(breaks = NULL)
