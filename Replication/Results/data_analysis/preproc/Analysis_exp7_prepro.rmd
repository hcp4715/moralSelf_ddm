...
# df.M1 <- df.M1[!(df.M1$Subject %in% procFailureSub),]
# df.C1 <- df.C1[!(df.C1$Subject %in% procFailureSub),]
...
setwd(ddmDir)
write.csv(df.M.hddm_m,'exp7_rep_match_hddm.csv',row.names = F)
write.csv(df.M.hddm_nm,'exp7_rep_mismatch_hddm.csv',row.names = F)
write.csv(df.C.hddm_val,'exp7_rep_categ_val_hddm.csv',row.names = F)
write.csv(df.C.hddm_id,'exp7_rep_categ_id_hddm.csv',row.names = F)
...
# write files
setwd(traDir)
write.csv(df.M1.V.sum_w,'exp7_rep_match_behav_wide.csv',row.names = F)
write.csv(df.M1.V.SDT_l,'exp7_rep_match__dprime_long.csv',row.names = F)
write.csv(df.M1.V.sum_rt_acc_l,'exp7_rep_match__rt_acc_long.csv',row.names = F)
setwd(curDir)
...
setwd(traDir)
write.csv(df.C1.V.sum_w,'exp7_rep_categ_behav_wide.csv',row.names = F)
write.csv(df.C1.V.sum_noTask_w,'exp7_rep_categ_behav_noTask_wide.csv',row.names = F)
write.csv(df.C1.V.sum_rt_acc_l,'exp7_rep_categ__rt_acc_long.csv',row.names = F)
