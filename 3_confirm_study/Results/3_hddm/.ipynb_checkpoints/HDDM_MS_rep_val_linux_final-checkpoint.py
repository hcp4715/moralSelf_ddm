...
print("P(v_M_GoodOther > v_M_BadOther )  = ", (v_GoodOther_val.trace() > v_BadOther_val.trace()).mean())    # 0.1666
print("P(v_M_GoodSelf  > v_M_GoodOther ) = ", (v_GoodSelf_val.trace()  > v_GoodOther_val.trace()).mean())   # 0.9902
print("P(v_M_BadSelf   > v_M_BadOther )  = ", (v_BadSelf_val.trace()   > v_BadOther_val.trace()).mean())    # 0.0718
...
print("P(z_M_GoodSelf  > z_M_BadSelf )   = ", (z_GoodSelf_val.trace()  > z_BadSelf_val.trace()).mean())      # 0.023
print("P(z_M_GoodOther > z_M_BadOther )  = ", (z_GoodOther_val.trace() > z_BadOther_val.trace()).mean())     # 0.9022 
print("P(z_M_GoodSelf  > z_M_GoodOther ) = ", (z_GoodSelf_val.trace()  > z_GoodOther_val.trace()).mean())    # 0.1192
print("P(z_M_BadSelf   > z_M_BadOther )  = ", (z_BadSelf_val.trace()   > z_BadOther_val.trace()).mean())     # 0.9842 
#print("P(z_M_BadSelf > z_M_GoodOther ) = ", (z_BadSelf_val.trace() > z_GoodOther_val.trace()).mean())     #  
#print("P(z_M_GoodSelf > z_M_BadOther ) = ", (z_GoodSelf_val.trace() > z_BadOther_val.trace()).mean())     # 

print("P(t_M_GoodSelf  > t_M_BadSelf )   = ", (t_GoodSelf_val.trace()  > t_BadSelf_val.trace()).mean())       # 0.0647 
print("P(t_M_GoodOther > t_M_BadOther )  = ", (t_GoodOther_val.trace() > t_BadOther_val.trace()).mean())      # 0.1046 
print("P(t_M_GoodSelf  > t_M_GoodOther ) = ", (t_GoodSelf_val.trace()  > t_GoodOther_val.trace()).mean())     # 0.1534
print("P(t_M_BadSelf   > t_M_BadOther )  = ", (t_BadSelf_val.trace()   > t_BadOther_val.trace()).mean())      # 0.2127
#print("P(t_M_GoodSelf > t_M_BadOther ) = ", (t_GoodSelf_val.trace() > t_BadOther_val.trace()).mean())     #  
#print("P(t_M_BadSelf > t_M_GoodOther ) = ", (t_BadSelf_val.trace() > t_GoodOther_val.trace()).mean())     # 