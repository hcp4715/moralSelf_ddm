...
# tmp <- aggregate(df.C1.V.acc[,7],list(df.C1.V.acc$Subject,df.C1.V.acc$Morality,df.C1.V.acc$Identity),mean)
df.C1.V.acc.noTask <- summarySE(df.C1.V.acc,measurevar = 'ACC',groupvars = c('Subject','Morality','Identity'))
df.C1.V.acc.noTask_w <- dcast(df.C1.V.acc.noTask, Subject ~  Morality + Identity  ,value.var = "ACC")

df.C1.V.acc.noTask_w$good_bad_slf <- df.C1.V.acc.noTask_w$Good_Self - df.C1.V.acc.noTask_w$Bad_Self
df.C1.V.acc.noTask_w$good_bad_oth <- df.C1.V.acc.noTask_w$Good_Self - df.C1.V.acc.noTask_w$Bad_Other
df.C1.V.acc.noTask_w$slf_oth_good <- df.C1.V.acc.noTask_w$Good_Self - df.C1.V.acc.noTask_w$Good_Other
df.C1.V.acc.noTask_w$slf_oth_bad <- df.C1.V.acc.noTask_w$Bad_Self - df.C1.V.acc.noTask_w$Bad_Other
