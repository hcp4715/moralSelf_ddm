...
lapply(pkgNeeded,pkgTest) # please pay attention to the overlap between differen libraries.
rm(pkgNeeded)             # remove the pkgNeeded variable

# using APA style plot for later use
