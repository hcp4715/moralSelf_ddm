...
pkgNeeded <- (c("ez","plyr","ggplot2", "reshape2", "MBESS", "bootES","BayesFactor","psych","corrplot"))
...
```{r loadingData_e7_L,echo=FALSE,results='hide'}
df.L <- read.csv("df.Learn.csv",header = TRUE, sep = ',', stringsAsFactors=FALSE)
df.T <- read.csv("df.Test.csv",header = TRUE, sep = ',', stringsAsFactors=FALSE)
...
df.L$Morality <- factor(df.L$Morality, levels=c("Good","Bad")) # make the variables in a specified order
df.L$Identity <- factor(df.L$Identity, levels=c("Self","Other")) # make the variables in a specified order
df.L$Match <- factor(df.L$Match, levels=c("match","nonmatch")) # make the variables in a specified order
...
df.T$Morality <- factor(df.T$Morality, levels=c("Good","Bad")) # make the variables in a specified order
df.T$Identity <- factor(df.T$Identity, levels=c("Self","Other")) # make the variables in a specified order
```

```{r clean the data_e7_L,echo=FALSE,results='hide',warning=FALSE, message=FALSE}
df.L1 <- df.L
df.T1 <- df.T
...
df.L1.V <- df.L1.valid[!(df.L1.valid$RT <= 200),] 
excld.trials.T <- df.T1.valid[df.T1.valid$RT <= 200,]
df.T1.V <- df.T1.valid[!(df.T1.valid$RT <= 200),] 
...
```{r correlation of self-effect on ACC between matching and categorization of moral,echo=FALSE,warning=FALSE,message=FALSE }
...
```{r correlation of self-effect on ACC between matching and categorization of id,echo=FALSE,warning=FALSE,message=FALSE }
...
The correlation of accuracy between matching task and categrization based on morality criteria
```{r correlation of moral-effect on ACC between matching and categorization of moral,echo=FALSE,warning=FALSE,message=FALSE }
...
The correlation of accuracy between matching task and categrization based on identity criteria
```{r correlation of moral-effect on ACC between matching and categorization of id,echo=FALSE,warning=FALSE,message=FALSE }
...
```{r correlation of self-effect on RT between matching and categorization of moral,echo=FALSE,warning=FALSE,message=FALSE }
...
```{r correlation of self-effect on RT between matching and categorization of id,echo=FALSE,warning=FALSE,message=FALSE }
...
```{r correlation of moral-effect on RT between matching and categorization of moral,echo=FALSE,warning=FALSE,message=FALSE }
...
```{r correlation of moral-effect on RT between matching and categorization of id,echo=FALSE,warning=FALSE,message=FALSE }
